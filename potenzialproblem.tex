...
\subsubsection{Algorithmusidee}
	...
	Nachdem wir für jeden Knoten die drei Parameter ausgerechnet haben, hat jeder Knoten die Information, wie viele Agenten an diesem gebraucht werden, wenn das Potential nicht angewendet wird ($\mu$); wie viele Agenten benötigt werden, wenn das Potential angewendet wird $\hat{\mu}$; und auf welche Kanten wir das Potential angewendet werden muss, um diese Verbesserung zu erreichen (die Kanten, die wir zur Berechnung von $\hat{\mu}$ reduziert haben).\\
